# ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
# Parts of this software are Copyright (c) 2001-2003 Vivendi Universal Net USA.
...
#~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
# $Id: Logger.pm,v 1.8 2009/05/27 21:54:38 impious Exp $
# $Source: /cvsroot/apollo-handler/apollo-utils/lib/ApolloUtils/Logger.pm,v $
#~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~

package ApolloUtils::Logger;
...
sub log {
      ...
      if (!defined($fh)) {
	    ...
	    $self->_prepdir($dirpath) || print STDERR "ApolloUtils::Logger: FAILED to Prepare log path $dirpath\n";
	    sysopen( $fh, $logpath, O_WRONLY|O_CREAT|O_APPEND, 0666 ) || print STDERR "ApolloUtils::Logger: FAILED to open log $logpath\n";

	    $self->{HANDLE} = $fh;

	    $self->log( "New Logger $logpath opened by $caller",'ApolloUtils::Logger','debug2'); # Yes, its recursive, but only once.
...
sub _prepdir{
      ...
      for (split(/\/+/,$dir)){
	    ...
	    if(-e _) {
		  print STDERR "ApolloUtils::Logger: ERROR! $path exists, but is not a directory.\n";
		  return undef
	    }
	    mkdir($path, 0775 ) || print STDERR "ApolloUtils::Logger: Failed to mkdir $path\n" && return undef;
      }
